...
public class SymulatorWycieczki {
    ...
    private final Set<SluchaczPostepow> sluchacze = new HashSet<>();
    ...
    public void symuluj() {
        ...
        System.out.println();
        System.out.println("Na wycieczce zostaną odwiedzone następujące atrakcje:");
        wycieczka.getElementy()
                .stream()
                .filter(ew -> ew instanceof Atrakcja)
                .map(ew -> (Atrakcja) ew)
                .forEach(atrakcja -> System.out.println(atrakcja.getNazwa()));
        System.out.println();
        System.out.println("Na wycieczkę idzie następująca grupa: ");
        grupa.getUczestnicy().forEach(System.out::println);
        System.out.println();
        ...
        for (pozycjaGrupy = 0; pozycjaGrupy < wycieczka.getLiczbaElementowWycieczki(); pozycjaGrupy++) {
            ...
            if (elementWycieczki instanceof Wedrowka) {
                ...
                System.out.println("Grupa odwiedza atrakcję: " + atrakcja.getNazwa());
    ...
    public void dodajSluchacza(SluchaczPostepow sluchacz) {
